      ...
      <div className="flex w-full rounded-lg border border-gray-400">
        ...
        <div className="relative flex items-center justify-center hover:bg-[#dce2ff] transition-colors duration-200">
          <select
            id="grade"
            name="grade"
            className="appearance-none h-full rounded-md rounded-r-lg border bg-transparent px-2 pr-8 text-sm font-medium text-gray-600 focus:ring-0 sm:text-base cursor-pointer"
            value={ageGroup}
